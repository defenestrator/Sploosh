...
class Client
{
     ...
     * @var string
     */
    protected $baseURI = 'http://waterservices.usgs.gov';

    /**
     * @var string
     */
    protected $WebServiceURI = '/nwis/iv/';
    ...
    public function __get($name)
    {
        ...
        $fullclass = "Sploosh\\" . str_replace(' ', '', $classname);
    ...
    {
        return $this->baseURI . $this->WebServiceURI . $this->action;
    }
}
